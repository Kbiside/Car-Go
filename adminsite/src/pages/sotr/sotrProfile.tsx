...
export default function EditEmployeePage() {
  ...
  const handleSave = () => {
    ...
    navigate(`/employees`); // Перенаправляем на страницу профиля после сохранения
  };

  const handleCancel = () => {
    navigate(`/employees/${employeeData.id}`); // Перенаправляем на страницу профиля без сохранения
  };
      ...
      <Stack gap="xl">
        ...
        <Group justify="flex-end">
          ...
          <Button 
            ...
            onClick={handleSave}
            component="a"
            href={`/employees/edit/${employeeData.id}`} // Ссылка на редактирование
          >
            Сохранить изменения
          </Button>
        </Group>
